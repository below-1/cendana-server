    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    body = request.body;
                    payload = __assign(__assign({}, body), { role: client_1.Role.CUSTOMER });
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    id = request.params.id;
                    return [4 /*yield*/, service_1.remove(id, client_1.Role.CUSTOMER)];
                case 1:
                    result = _a.sent();
                    return [2 /*return*/, result];
            }
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, service_1.find(client_1.Role.CUSTOMER, keyword, options)];
                case 1:
                    result = _b.sent();
                    reply.send(result);
                    return [2 /*return*/];
