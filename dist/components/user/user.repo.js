...
exports.findUser = exports.findOneUserByUsername = exports.remove = exports.update = exports.create = void 0;
...
function findOneUserByUsername(username) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, prisma_1.prisma.user.findFirst({
                        where: {
                            username: username
                        }
                    })];
...
function findUser(role, keyword, options) {
    return __awaiter(this, void 0, void 0, function () {
