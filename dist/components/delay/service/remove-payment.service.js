...
function removePayment(id) {
    return __awaiter(this, void 0, void 0, function () {
        var payment, delayId, removeStatement, updateDelayStatement;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, prisma_1.prisma.transaction.findFirst({
                        where: {
                            id: id
                        }
                    })];
                case 1:
                    ...
                    delayId = payment.delayId;
                    removeStatement = prisma_1.prisma.transaction.delete({
                        where: { id: id }
                    });
                    updateDelayStatement = prisma_1.prisma.delay.update({
                        where: { id: delayId },
                        data: {
                            complete: false
                        }
