...
function remove(id) {
    return __awaiter(this, void 0, void 0, function () {
        var order, orderItems, statements, _i, orderItems_1, orderItem, product, updateStockStatement, deleteStatement;
            ...
            switch (_a.label) {
                ...
                case 2:
                    ...
                    for (_i = 0, orderItems_1 = orderItems; _i < orderItems_1.length; _i++) {
                        ...
                        updateStockStatement = prisma_1.prisma.product.update({
                            where: { id: product.id },
                            data: {
                    ...
                    deleteStatement = prisma_1.prisma.order.delete({ where: { id: id } });
