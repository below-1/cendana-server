...
exports.Print = exports.Find = exports.RemoveStockItemParam = exports.AddStockItem = exports.SealTransaction = exports.Update = exports.Create = void 0;
...
var Print;
(function (Print) {
    Print.Obj = typebox_1.Type.Object({
        year: typebox_1.Type.Number(),
        month: typebox_1.Type.Number()
    });
