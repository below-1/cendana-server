            ...
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, prisma_1.prisma.order.create({
                            data: __assign(__assign({}, rest), { grandTotal: 0, subTotal: 0, tax: 0, shipping: 0, discount: 0, orderStatus: client_1.OrderStatus.OPEN, orderType: client_1.OrderType.BUY, author: {
                                    connect: { id: authorId }
                                }, targetUser: {
