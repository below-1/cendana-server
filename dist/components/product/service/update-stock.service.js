...
function updateStocks(id) {
    return __awaiter(this, void 0, void 0, function () {
        var currentStockInfo, stockItems, data, lastStockItem;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, prisma_1.prisma.stockItem.aggregate({
                        _sum: {
                            available: true,
                            defect: true,
                            returned: true,
