...
function snapshotInventory(target) {
    return __awaiter(this, void 0, void 0, function () {
        var hpp;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, prisma_1.prisma.$queryRaw("\n    select sum(p.available * p.\"sellPrice\") total from \"Product\" p")];
                case 1:
                    hpp = (_a.sent())[0].hpp;
...
function snapshotEquity(target) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    initial = new runtime_1.Decimal('0');
                    t0 = new Date(2015, 0, 1);
                    t1 = target;
                    return [4 /*yield*/, prisma_1.prisma.recordEquity.findFirst({
                            where: {
                                createdAt: {
                                    lt: target
                                }
...
function snapshot(target) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, snapshotEquity(target)];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, snapshotInventory(target)];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
