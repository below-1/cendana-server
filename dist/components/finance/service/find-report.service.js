...
var ReportNotFound = fastify_error_1.default('FST_REPORT_NOT_FOUND', "Laporan untuk %s tidak ditemukan");
function findReport(options) {
    return __awaiter(this, void 0, void 0, function () {
        var startDate, endDate, report, targetLabel, aktiva;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, prisma_1.prisma.financeReport.findFirst({
                            where: {
                                target: endDate
                            }
                        })];
                case 1:
                    report = _a.sent();
                    if (!report) {
                        targetLabel = date_fns_1.format(endDate, 'MMMM yyyy', { locale: locale_1.id });
                        throw new ReportNotFound(targetLabel);
                    }
                    aktiva = report.aktivaLancar ? report.aktivaLancar : new runtime_1.Decimal('0');
                    if (report.aktivaTetap) {
                        aktiva = aktiva.add(report.aktivaTetap);
                    }
                    return [2 /*return*/, __assign(__assign({}, report), { aktiva: aktiva })];
            }
        });
    });
}
