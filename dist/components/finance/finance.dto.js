...
exports.FindReport = exports.CreateReport = exports.Snapshot = exports.Neraca = exports.PerubahanModal = exports.LabaRugi = exports.RespType = exports.RespTypeEnum = void 0;
...
(function (CreateReport) {
    CreateReport.Obj = typebox_1.Type.Object({
        month: typebox_1.Type.Number(),
        year: typebox_1.Type.Number(),
        pajak: typebox_1.Type.String()
    });
})(CreateReport = exports.CreateReport || (exports.CreateReport = {}));
var FindReport;
(function (FindReport) {
    FindReport.Obj = typebox_1.Type.Object({
        month: typebox_1.Type.Number(),
        year: typebox_1.Type.Number()
    });
})(FindReport = exports.FindReport || (exports.FindReport = {}));
