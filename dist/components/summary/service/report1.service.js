...
function report1(_a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var _b, lowerDate, upperDate, pgDateFormat, slower, supper, items;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    _b = to_date_upper_lower_1.toDateUpperLower(year, month), lowerDate = _b.lower, upperDate = _b.upper;
                    pgDateFormat = 'yyyy-MM-dd';
                    slower = date_fns_1.format(lowerDate, pgDateFormat);
                    supper = date_fns_1.format(upperDate, pgDateFormat);
                    console.log(slower);
                    console.log(supper);
